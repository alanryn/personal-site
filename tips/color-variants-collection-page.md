...
{% comment %}
    ...
    Accepts:
    - card_product: {Object} Variant Liquid object (optional)
          ...
          <div class="quick-add">
            ...
            {%- else -%}
              ...
              <quick-add-modal id="QuickAdd-{{ card_product.id }}" class="quick-add-modal">
                <div role="dialog" aria-label="{{ 'products.product.choose_product_options' | t: product_name: title | escape }}" aria-modal="true" class="quick-add-modal__content global-settings-popup" tabindex="-1">
